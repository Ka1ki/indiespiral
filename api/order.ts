...
const route = "/shop/order";

//Preview order
export function previewOrderOptions(body: any, query?: any) {
	return createQueryOptions([route, "preview", body], () =>
		crud.post(`${route}/preview`, body, query)
	);
}
